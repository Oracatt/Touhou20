...
namespace ImGui
{
    ...
    IMGUI_API bool          Begin(const char* name, bool* p_open = NULL, ImGuiWindowFlags flags = 0, bool* p_min = NULL);
    IMGUI_API void          End();
    ...
    IMGUI_API void          Columns(int count = 1, const char* id = NULL, bool border = true, bool resize = false, float default_offset[] = nullptr);

/* Entry: 0x0051d3e0; symbol: FUN_0051d3e0; body bytes: 488 */

void __thiscall FUN_0051d3e0(void *this,int param_1,undefined4 param_2)

{
  ...
  *unaff_FS_OFFSET = (int)&local_10;
  ...
  FUN_0051d890(pvVar1,uVar6,uVar5);

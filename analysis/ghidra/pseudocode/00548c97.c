/* Entry: 0x00548c97; symbol: FUN_00548c97; body bytes: 397 */

uint __fastcall FUN_00548c97(void *param_1)
...
LAB_00548d78:
  ...
  if (*(int *)((int)param_1 + 0x24) < 0) {
    ...
    *(uint *)((int)param_1 + 0x1c) = uVar8 & 0xfffffff7;
    FUN_00548966((void *)((int)param_1 + 0x3c),*(uint *)((int)param_1 + 0x24),
                 *(int *)((int)param_1 + 8));
  }
  ...
  *(undefined1 *)((int)param_1 + 0x38) = 0;
  if (uVar5 == 8) {
    FUN_0054929b(param_1,uVar7,local_c);
  }
  else {
    FUN_0054913e(param_1,uVar7);
  }
  ...
  if ((((uint)pcVar6 & 1) != 0) &&
    ...
    **(undefined1 **)((int)param_1 + 0x30) = 0x30;

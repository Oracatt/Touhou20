/* Entry: 0x004efec0; symbol: FUN_004efec0; body bytes: 350 */

void __cdecl
FUN_004efec0(undefined4 *param_1,undefined4 param_2,int param_3,int *param_4,char param_5,
            void *param_6)

{
  ...
  move<>(&param_2);
  puVar1 = FUN_004f5b10(param_6,&local_34);

/* Entry: 0x00554ae0; symbol: FUN_00554ae0; body bytes: 564 */

uint * __cdecl FUN_00554ae0(uint *param_1,uint param_2,uint param_3,uint param_4)
...
LAB_00554cee:
      ...
      if (local_14 == (LPCVOID)0x0) goto LAB_00554cee;
...
LAB_00554be3:
          if (local_14 == (LPCVOID)0x0) goto LAB_00554b58;
          bVar3 = true;
          local_8 = pvVar1;
        }
        else {

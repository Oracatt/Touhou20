/* Entry: 0x004ef520; symbol: FUN_004ef520; body bytes: 350 */

void __cdecl
FUN_004ef520(undefined4 *param_1,undefined4 param_2,int param_3,int *param_4,char param_5)

{
  ...
  puVar1 = FUN_004f5a00(&local_34,*puVar1);

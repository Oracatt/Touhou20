/* Entry: 0x004c9830; symbol: FUN_004c9830; body bytes: 635 */

void __thiscall FUN_004c9830(void *this,undefined4 param_1,int param_2)
  ...
  if ((param_2 == 0) || (*(int *)((int)this + 0x6cc) == 0)) {
    ...
    for (; DAT_0056cd90 / DAT_0056c8d0 + local_28 < *(float *)((int)local_24 + 0x74);
      ...
      if (((*(int *)((int)local_24 + 0x6e4) < 0x12) || (*(int *)((int)local_24 + 0x6e4) == 0x22)) ||
        ...
        local_34 = *(int *)((int)local_24 + 0x720) * 2 + 0xd4;
        FUN_004790e0(&local_4c,(uint *)"bullet",local_34,&local_14,0,-1,(undefined4 *)0x0);
      }
      else if ((*(int *)((int)local_24 + 0x6e4) < 0x20) || (*(int *)((int)local_24 + 0x6e4) == 0x1b)
              ) {
        iVar2 = FUN_0040c300(*(undefined4 **)((int)local_24 + 0x6f0));
        local_40 = FUN_004859b0(iVar2);
        local_3c = *(int *)((int)local_24 + 0x720) * 2 + 0x104;
        ...
        local_44 = *(int *)((int)local_24 + 0x720) * 2 + 0x11c;

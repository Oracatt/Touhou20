/* Entry: 0x004ac420; symbol: FID_conflict:_Func_impl_no_alloc<class_`protected:_void___thiscall_Concurrency::target_block<class_Concurrency::multi_link_registry<class_Concurrency::ISource<unsigned_int>_>,class_Concurrency::ordered_message_processor<unsigned_int>_>::initialize_target(class_Concurrency::Scheduler*,class_Concurrency::ScheduleGroup*)'::`2'::<lambda_1>,void,class_Concurrency::message<unsigned_int>*><class_`protected:_void___thiscall_Concurrency::target_block<class_Concurrency::multi_link_registry<class_Concurrency::ISource<unsigned_int>_>,class_Concurrency::ordered_message_processor<unsigned_int>_>::initialize_target(class_Concurrency::Scheduler*,class_Concurrency::ScheduleGroup*)'::`2'::<lambda_1>,0>; body bytes: 53 */

/* Library Function - Multiple Matches With Different Base Names
    public: __thiscall std::_Func_impl_no_alloc<class `protected: void __thiscall
   ...
   int> *>::_Func_impl_no_alloc<class `protected: void __thiscall Concurrency::target_block<class
   ...
   >::enable_batched_processing(void)'::`2'::<lambda_1>,void,class Concurrency::message<unsigned
   int> *><class `protected: void __thiscall Concurrency::target_block<class
   Concurrency::multi_link_registry<class Concurrency::ISource<unsigned int> >,class
   Concurrency::ordered_message_processor<unsigned int>
   >::enable_batched_processing(void)'::`2'::<lambda_1>,0>(class `protected: void __thiscall
   Concurrency::target_block<class Concurrency::multi_link_registry<class
   Concurrency::ISource<unsigned int> >,class Concurrency::ordered_message_processor<unsigned int>
   ...
   *)'::`2'::<lambda_1>,void,class Concurrency::message<unsigned int> *>::_Func_impl_no_alloc<class
   ...
   Concurrency::message<unsigned int> *><class `protected: void __thiscall
   Concurrency::source_block<class Concurrency::multi_link_registry<class
   Concurrency::ITarget<unsigned int> >,class Concurrency::ordered_message_processor<unsigned int>
   >::initialize_source(class Concurrency::Scheduler *,class Concurrency::ScheduleGroup
   *)'::`2'::<lambda_1>,0>(class `protected: void __thiscall Concurrency::source_block<class
   Concurrency::multi_link_registry<class Concurrency::ITarget<unsigned int> >,class
   Concurrency::ordered_message_processor<unsigned int> >::initialize_source(class
   ...
   Concurrency::ScheduleGroup *)'::`2'::<lambda_1>,void,class Concurrency::message<enum
   Concurrency::agent_status> *>::_Func_impl_no_alloc<class `protected: void __thiscall
   Concurrency::source_block<class Concurrency::multi_link_registry<class Concurrency::ITarget<enum
   Concurrency::agent_status> >,class Concurrency::ordered_message_processor<enum
   Concurrency::agent_status> >::initialize_source(class Concurrency::Scheduler *,class
   Concurrency::ScheduleGroup *)'::`2'::<lambda_1>,void,class Concurrency::message<enum
   Concurrency::agent_status> *><class `protected: void __thiscall Concurrency::source_block<class
   Concurrency::multi_link_registry<class Concurrency::ITarget<enum Concurrency::agent_status>
   >,class Concurrency::ordered_message_processor<enum Concurrency::agent_status>
   >::initialize_source(class Concurrency::Scheduler *,class Concurrency::ScheduleGroup
   *)'::`2'::<lambda_1>,0>(class `protected: void __thiscall Concurrency::source_block<class
   Concurrency::multi_link_registry<class Concurrency::ITarget<enum Concurrency::agent_status>
   >,class Concurrency::ordered_message_processor<enum Concurrency::agent_status>
...

{
  ...
  _Get_first((_Compressed_pair<struct_std::default_delete<class_std::_Facet_base>,class_std::_Facet_base*,1>
              *)this);
  *(undefined ***)this = &PTR_Copy_0057079c;

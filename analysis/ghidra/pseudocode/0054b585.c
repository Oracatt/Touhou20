/* Entry: 0x0054b585; symbol: parse_floating_point_possible_nan_is_ind<>; body bytes: 64 */

/* Library Function - Multiple Matches With Same Base Name
    bool __cdecl __crt_strtox::parse_floating_point_possible_nan_is_ind<wchar_t,class
...
undefined4 __cdecl parse_floating_point_possible_nan_is_ind<>(ushort *param_1,undefined4 *param_2)

{
  ...
  do {
    uVar1 = *param_1;
    uVar2 = (uint)uVar1;
    if ((uVar1 != *(ushort *)((int)&DAT_00598960 + iVar4)) &&
       (uVar1 != *(ushort *)((int)&DAT_00598968 + iVar4))) goto LAB_0054b5be;

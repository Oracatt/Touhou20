/* Entry: 0x0040d4b0; symbol: FUN_0040d4b0; body bytes: 298 */

void __thiscall FUN_0040d4b0(void *this,uint param_1)

{
  ...
  *(uint *)((int)this + 0x14) = local_c;
  ...
  if (uVar1 < 0x10) {
    FID_conflict_operator__(puVar5,(uint *)this,uVar7);
    ...
    FID_conflict_operator__(puVar5,puVar6,uVar7);

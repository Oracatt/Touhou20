/* Entry: 0x004ea270; symbol: FUN_004ea270; body bytes: 2353 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void __cdecl FUN_004ea270(undefined4 *param_1,undefined4 param_2,float param_3,int *param_4)

{
  ...
  *unaff_FS_OFFSET = (int)&local_1c;
  ...
  local_59b = FUN_004fff60((uint)param_3);
  bVar1 = FUN_004f3750();
  if (bVar1) {
  ...
  else if (local_61c == 0xffffffff) {
    if (local_61f == '\0') {
      fVar6 = param_3;
      iVar7 = local_628;
      puVar2 = (uint *)FUN_004f3340((int)local_598);
      uVar5 = FUN_005000f0((uint *)local_598,puVar2,fVar6,iVar7);
      ...
      fVar6 = param_3;
      puVar2 = (uint *)FUN_004f3340((int)local_598);
      uVar5 = FUN_005000b0((uint *)local_598,puVar2,fVar6);
    ...
    sVar8 = local_61c;
    puVar2 = (uint *)FUN_004f3340((int)local_598);
    uVar5 = FUN_004710f0((uint *)local_598,puVar2,fVar6,iVar7,sVar8);
  ...
  if (local_61d != '\0') {
    if ((*(char *)((int)param_4 + 0xb) != '\0') || ((char)param_4[3] != '\0')) {
      ...
      if ((char)param_4[3] != '\0') {
        local_674 = FUN_004fbf20(&stack0x00000014,local_688);
        local_14._0_1_ = 1;
        local_650 = local_674;
    ...
    case 2:
      if ((*(char *)((int)param_4 + 0xb) != '\0') &&
        ...
        if (local_60c == local_604) {
          fVar4 = (float10)FUN_004fe850(param_3);
          local_690 = (double)fVar4;
          if ((local_690 < DAT_0056c468) && ((double)param_3 != _DAT_0056cd50)) {
  ...
  local_59c = local_61e;
  FUN_004f3c60(local_5fc,&local_599,&local_59b,&local_59c,&local_5a0,param_4,&stack0x00000014,

/* Entry: 0x0040cb30; symbol: FUN_0040cb30; body bytes: 273 */

void __thiscall FUN_0040cb30(void *this,uint *param_1,uint param_2)

{
  ...
  uVar1 = FUN_00411200((_Compressed_pair<struct_std::default_delete<class_std::_Facet_base>,class_std::_Facet_base*,1>
                        *)this);
  if (uVar1 < param_2) {
    FUN_0040fb00();
  }
  ...
  if (param_2 < 0x10) {
    ...
    *(undefined4 *)((int)this + 0x14) = 0xf;
    FUN_0040ffd0((uint *)this,param_1,0x10);
    FUN_0040e5e0();
  }
  else {
    uVar1 = FUN_00411200((_Compressed_pair<struct_std::default_delete<class_std::_Facet_base>,class_std::_Facet_base*,1>
    ...
    local_14 = FUN_0040c800(paVar2,&local_10);

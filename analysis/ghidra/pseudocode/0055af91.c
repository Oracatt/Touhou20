/* Entry: 0x0055af91; symbol: FUN_0055af91; body bytes: 327 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_0055af91(void)
  ...
  if (cVar1 != '\0') {
    if (cVar1 == -1) {
      ...
      if (uVar2 == 0) {
        *(undefined4 *)(unaff_EBP + -0x8e) = 4;
        in_ST0 = (float10)fscale(in_ST0,(float10)_DAT_0059a7a8);
        if (ABS(in_ST0) < (float10)_DAT_0059a798) {
          in_ST0 = in_ST0 * (float10)_DAT_0059a7b8;
        }
        goto LAB_0055b076;
      }
    }
    if (uVar2 == 0x7ff0) {
      *(undefined4 *)(unaff_EBP + -0x8e) = 3;
      in_ST0 = (float10)fscale(in_ST0,(float10)_DAT_0059a7a0);
      if ((float10)_DAT_0059a790 < ABS(in_ST0)) {
        in_ST0 = in_ST0 * (float10)_DAT_0059a7b0;
      }
      goto LAB_0055b076;
    }
  }
...
LAB_0055b076:
  ...
  *(double *)(unaff_EBP + -0x76) = (double)in_ST0;
  FUN_00564100((int)*(char *)(*(int *)(unaff_EBP + -0x94) + 0xe),(int *)(unaff_EBP + -0x8e),

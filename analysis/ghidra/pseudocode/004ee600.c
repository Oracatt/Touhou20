/* Entry: 0x004ee600; symbol: FUN_004ee600; body bytes: 309 */

void __thiscall FUN_004ee600(void *this,uint param_1,undefined4 param_2,size_t param_3,char param_4)

{
  ...
  *(uint *)((int)this + 0x18) = local_c;
  ...
  if (uVar1 < 0x10) {
    FID_conflict_operator__(puVar6,puVar3,uVar8,param_3,param_4);
    FUN_0040cd70(puVar3,&local_10);
  }
  else {
    uVar2 = *puVar3;
    puVar7 = (uint *)move<>(uVar2);
    FID_conflict_operator__(puVar6,puVar7,uVar8,param_3,param_4);

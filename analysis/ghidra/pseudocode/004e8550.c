/* Entry: 0x004e8550; symbol: FUN_004e8550; body bytes: 534 */

void __cdecl FUN_004e8550(uint *param_1,uint *param_2,double param_3)

{
  ...
  *unaff_FS_OFFSET = (int)&local_10;
  ...
  if (bVar1) {
    if (param_1 == param_2) goto LAB_004e874d;
  ...
  if ((local_1c._4_4_ & 0x7ff00000) == 0x7ff00000) {
    ...
    FUN_004e9580(param_1,param_2,param_3,0);
  }
LAB_004e874d:

/* Entry: 0x00530e80; symbol: FUN_00530e80; body bytes: 421 */

void FUN_00530e80(void)

{
  ...
  if (bVar1) {
    local_1c = DAT_0056fd48;
  }
  else {
    local_1c = DAT_00570560;
  }
  fVar6 = local_1c;
  ...
  *(int *)(local_18 + 0x74) = (int)(local_10 * DAT_0056cd98) + *(int *)(iVar2 + 4);
  ...
  if (bVar1) {
    ...
    pfVar4 = (float *)FUN_00452f80(local_24,local_2c,DAT_0056e0f0 / DAT_00570560);
    ...
    pfVar4 = (float *)FUN_00452f80(local_20,local_28,DAT_0056e0f0 / DAT_00570ad0);
    fVar5 = FUN_004292e0(pfVar4);
    fVar5 = FUN_00438540((float)fVar5);
    FUN_00452f20((void *)(local_18 + 0xd4),(float)fVar5);
  }

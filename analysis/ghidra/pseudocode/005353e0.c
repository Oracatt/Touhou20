/* Entry: 0x005353e0; symbol: FUN_005353e0; body bytes: 659 */

void __thiscall FUN_005353e0(void *this,int param_1)

{
  ...
  for (local_50 = 0; local_50 < param_1; local_50 = local_50 + 1) {
    ...
    local_10 = puVar3[1];
    local_c = puVar3[2];
    local_5c = (void *)FUN_00414580(&DAT_005c6960,local_50);
    ...
    if (bVar1) {
      ...
      local_64 = *puVar3;
      puVar3 = (undefined4 *)FUN_00414580(&DAT_005c6960,local_50);
      *puVar3 = local_64;
      local_68 = (void *)FUN_00414580(&DAT_005c6960,local_50);
      FUN_004506b0(local_68,DAT_0056cd94,DAT_0056c8cc);
      puVar3 = (undefined4 *)FUN_00414580(&DAT_005c6974,local_50);
      FUN_004c1f00(puVar3);
    ...
    local_80 = (void *)FUN_00414580(&DAT_005c6960,local_50);
    FUN_004645e0(local_80,&local_14);
    local_84 = (void *)FUN_00414580(&DAT_005c6974,local_50);
    FUN_004c1ff0(local_84,&local_14);
  }
  for (local_54 = param_1; local_54 < 4; local_54 = local_54 + 1) {
    puVar3 = (undefined4 *)FUN_00414580(&DAT_005c6960,local_54);
    FUN_0044fcd0(puVar3);
    puVar3 = (undefined4 *)FUN_00414580(&DAT_005c6974,local_54);
    FUN_004c1f00(puVar3);
  }

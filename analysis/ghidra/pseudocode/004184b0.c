/* Entry: 0x004184b0; symbol: FUN_004184b0; body bytes: 298 */

void __thiscall FUN_004184b0(void *this,uint param_1)

{
  ...
  *(uint *)((int)this + 0x14) = local_c;
  ...
  if (uVar1 < 8) {
    FID_conflict_operator__(puVar5,(uint *)this,iVar7);
    ...
    FID_conflict_operator__(puVar5,puVar6,iVar7);

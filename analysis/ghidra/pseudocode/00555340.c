/* Entry: 0x00555340; symbol: FUN_00555340; body bytes: 396 */

uint * __cdecl FUN_00555340(uint *param_1,uint param_2,uint param_3)
...
LAB_005554b5:
  ...
  if ((param_3 == 0) || ((param_3 & param_3 - 1) != 0)) goto LAB_005554b5;
  uVar12 = 4;
  if (4 < param_3) {
    uVar12 = param_3;
  }

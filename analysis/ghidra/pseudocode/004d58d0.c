/* Entry: 0x004d58d0; symbol: FUN_004d58d0; body bytes: 433 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

undefined4 __fastcall FUN_004d58d0(int param_1)

{
  ...
  if (bVar1) {
    *(uint *)(local_8 + 0x698) = *(uint *)(local_8 + 0x698) & 0xfffffffb;
    return 1;
  }
  ...
  *(float *)(local_8 + 0x7c) = local_24 + local_28;
  ...
  if (local_38 <= _DAT_0056fd30) {
    ...
    if (local_3c <= _DAT_0056fd30) goto LAB_004d5a5d;
  }

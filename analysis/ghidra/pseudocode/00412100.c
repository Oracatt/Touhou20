/* Entry: 0x00412100; symbol: FUN_00412100; body bytes: 381 */

void __thiscall FUN_00412100(void *this,int *param_1,int param_2)

{
  ...
  *param_1 = param_2;
  ...
  FUN_00412280((void *)((int)this + 0x1c),local_1c);
  ...
  do {
    ...
    if (!bVar2) {
      ...
      FUN_00411ea0((void *)((int)this + 0x1c),param_1 + 5);
      local_8 = 0xffffffff;

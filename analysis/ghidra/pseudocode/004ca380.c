/* Entry: 0x004ca380; symbol: FUN_004ca380; body bytes: 1197 */

void __thiscall
FUN_004ca380(void *this,float *param_1,float *param_2,float param_3,undefined4 param_4,int param_5)
  ...
  if ((param_5 == 0) || (*(int *)((int)this + 0x6cc) == 0)) {
    ...
    for (; DAT_0056cd90 / DAT_0056c8d0 + local_23c <= (float)local_230[0x1d];
      ...
      cVar1 = FUN_004580c0(*param_1,param_1[1],*param_2,param_2[1],param_3,local_214,local_210,
                           local_220,local_21c,(float)local_230[0x1c]);
      if (cVar1 != '\0') {

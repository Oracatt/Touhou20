/* Entry: 0x004f6920; symbol: FUN_004f6920; body bytes: 800 */

undefined4 * __thiscall FUN_004f6920(void *this,undefined4 *param_1,undefined4 param_2)

{
  ...
  *unaff_FS_OFFSET = (int)&local_1c;
  ...
  if ((*(int *)(local_2c + 4) < 1) && (*(int *)(local_2c + 4) < 0)) {
    local_25 = '\x01';
  }
  else {
    local_25 = '\0';

/* Entry: 0x00483d20; symbol: FUN_00483d20; body bytes: 468 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

undefined4 __fastcall FUN_00483d20(int param_1)

{
  ...
  if (bVar1) {
    *(uint *)(local_8 + 0x90) = *(uint *)(local_8 + 0x90) & 0xffdfffff;
    return 1;
  }
  ...
  *(float *)(local_8 + 0x20) = local_24 + local_28;
  ...
  if (local_38 <= _DAT_0056fd30) {
    ...
    if (local_3c <= _DAT_0056fd30) goto LAB_00483ecf;
  }

/* Entry: 0x00536280; symbol: FUN_00536280; body bytes: 721 */

void __fastcall FUN_00536280(int param_1)

{
  ...
  if (!bVar1) {
    ...
    while( true ) {
      ...
      local_14 = pfVar4[1];
      local_10 = pfVar4[2];
      local_6c = (void *)FUN_00414580(&DAT_005c6984,local_58);
      ...
      if (bVar1) {
        ...
        local_74 = *puVar5;
        puVar5 = (undefined4 *)FUN_00414580(&DAT_005c6984,local_58);
        *puVar5 = local_74;
        local_78 = (void *)FUN_00414580(&DAT_005c6984,local_58);
        FUN_004506b0(local_78,DAT_0056cd94,DAT_0056c8cc);
      }
      local_7c = (void *)FUN_00414580(&DAT_005c6984,local_58);
      ...
      if (*(int *)(local_54 + 0x58) == 0) {
        ...
        FUN_00535900(auStack_c8,local_c);

/* Entry: 0x004cf080; symbol: FUN_004cf080; body bytes: 1225 */

void __thiscall
FUN_004cf080(void *this,float *param_1,float param_2,undefined4 param_3,float param_4,int param_5,
...

{
  ...
  local_230 = (int *)this;
  if ((param_7 == 0) || (*(int *)((int)this + 0x6cc) == 0)) {
    local_234 = 0;
    local_238 = 0;
    ...
    for (; DAT_0056cd90 / DAT_0056c8d0 + local_23c <= (float)local_230[0x1d];
      ...
      cVar1 = FUN_00458670(local_214,local_210,local_220,local_21c,(float)local_230[0x1c],*param_1,
                           param_1[1],param_2 * param_2,param_3,param_4,param_5);
      if (cVar1 != '\0') {
        ...
        *local_240 = *local_240 + 1;
        if (((local_230[0x1b9] < 0x12) || (local_230[0x1b9] == 0x22)) || (local_230[0x1b9] == 0x26))
        {
          iVar3 = FUN_0040c300((undefined4 *)local_230[0x1bc]);
          local_24c = FUN_004859b0(iVar3);
          local_248 = local_230[0x1c8] * 2 + 0xd4;
          ...
          local_250 = local_230[0x1c8] * 2 + 0x104;
          ...
          local_258 = local_230[0x1c8] * 2 + 0x11c;

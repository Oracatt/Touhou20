/* Entry: 0x0044a210; symbol: FUN_0044a210; body bytes: 394 */

void __thiscall FUN_0044a210(void *this,int param_1)

{
  ...
  *unaff_FS_OFFSET = (int)&local_10;
  ...
  FUN_00412280((void *)((int)this + 0x18),local_1c);
  local_8 = 0;
  ...
  while( true ) {
    ...
    if (*(int *)(*piVar5 + 0x570) == 0) {
      ...
      if ((local_20 < 0x1d) || (0x24 < local_20)) {
        if (local_20 == 0x1a) {
          local_20 = 0x2d;
        }
        else {

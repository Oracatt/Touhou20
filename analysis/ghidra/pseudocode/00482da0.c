/* Entry: 0x00482da0; symbol: FUN_00482da0; body bytes: 281 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

undefined4 __fastcall FUN_00482da0(int param_1)

{
  ...
  if (*(float *)(param_1 + 0x68) < DAT_0056d7c0 / DAT_0056c8d0 + local_c / DAT_0056c8d0) {
    uVar2 = 0;
  }
  else {
    iVar1 = FUN_0047c680((void *)(param_1 + 0xa0),4);

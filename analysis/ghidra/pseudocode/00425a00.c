/* Entry: 0x00425a00; symbol: FUN_00425a00; body bytes: 202 */

void __cdecl FUN_00425a00(undefined4 param_1,int param_2,uint *param_3)

{
  ...
  if (param_2 != 0) {
    ...
    cVar1 = FUN_00411170();
    if ((cVar1 == '\0') && (cVar1 = FUN_00425380(param_3), cVar1 != '\0')) {

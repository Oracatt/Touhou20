/* Entry: 0x0044b020; symbol: FUN_0044b020; body bytes: 578 */

void __cdecl
FUN_0044b020(void *param_1,undefined8 *param_2,int param_3,undefined4 param_4,undefined4 param_5,
...

{
  ...
  *(byte *)(param_3 + 0x49a) = *(byte *)(param_3 + 0x49a) | 1;
  ...
  fVar6 = ((float)((double)(int)sVar4 + *(double *)(&DAT_0056cdd0 + ((int)sVar4 >> 0x1f) * -8)) *
          fVar5) / DAT_0056c8d0;
  fVar5 = *(float *)(iVar3 + 0x4c);
  uVar2 = FUN_00445a00(param_1,*(uint *)(iVar3 + 8));
  function<>(auStack_580,(int)&stack0x00000024);
  FUN_0044fff0(param_2,uVar2,iVar3,(int)(fVar5 - fVar6),param_4,param_5,(LPCSTR)local_514,

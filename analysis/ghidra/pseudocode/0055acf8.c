/* Entry: 0x0055acf8; symbol: FUN_0055acf8; body bytes: 6 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

float10 FUN_0055acf8(double param_1)

{
  ...
  if (uVar2 < 0x10c6) {
    dVar9 = (DAT_0059a6d0 * param_1 + DAT_0059a6d8) - DAT_0059a6d8;
    iVar3 = ((int)ROUND(DAT_0059a6d0 * param_1) + 0x1c7610U & 0x3f) * 0x20;
    dVar10 = _DAT_0059a6e0 * dVar9;
    dVar4 = param_1 - DAT_0059a6f0 * dVar9;
    dVar14 = param_1 - DAT_0059a6f0 * dVar9;
  ...
  if ((short)uVar2 < 0x10c6) {
    return (float10)(DAT_0059a720 -
                    (double)((ulonglong)param_1 & 0xffffffffffff |
                            (ulonglong)(uVar1 & 0x7fff) << 0x30));
  }
  FUN_0055ac3f(in_ECX,param_1._0_4_,param_1._4_4_);
  return extraout_ST0;
}

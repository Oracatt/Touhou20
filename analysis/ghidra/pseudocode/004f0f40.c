/* Entry: 0x004f0f40; symbol: FUN_004f0f40; body bytes: 1263 */

void __cdecl
FUN_004f0f40(undefined4 *param_1,undefined4 param_2,uint param_3,uint param_4,int param_5,
...

{
  ...
  *unaff_FS_OFFSET = (int)&local_1c;
  ...
  if ((char)param_7 == 'c') {
    puStack_20 = &stack0xfffffffc;
    cVar1 = FUN_004ecaa0(param_3,param_4);
    if (cVar1 == '\0') {
    ...
    local_dc = FUN_00459240(&local_70,local_f0,local_110,local_10c,local_d4);
    local_c8 = &local_70;
    local_78 = (int)(char *)local_dc - (int)local_c8;
    if ((int)param_4 < 0) {
      local_c8 = acStack_6f;
    }
    else if (param_7._2_1_ != '\x02') {
      local_78 = local_78 + 1;
    }
    if ((char)param_7 == 'X') {
    ...
    if (local_71 == '\0') {
      ...
      puVar3 = (undefined4 *)move<>(&param_2);
      local_104 = *puVar3;
      FUN_004efc00(param_1,local_104,local_100,&param_5,'\x02',local_c4);
      local_14 = 0xffffffff;
      FUN_0040e5a0(local_9c);
    }
    else {
      puVar3 = (undefined4 *)move<>(&param_2);
      FUN_004f6920(local_c4,param_1,*puVar3);
      local_14 = 0xffffffff;
      FUN_0040e5a0(local_9c);
    }
  }

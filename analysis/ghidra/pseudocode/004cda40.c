/* Entry: 0x004cda40; symbol: FUN_004cda40; body bytes: 1200 */

void __thiscall
FUN_004cda40(void *this,float *param_1,undefined4 param_2,float param_3,int param_4,
...

{
  ...
  if ((param_6 == 0) || (*(int *)((int)this + 0x6cc) == 0)) {
    ...
    for (; DAT_0056cd90 / DAT_0056c8d0 + local_23c <= (float)local_230[0x1d];
      ...
      cVar1 = FUN_00457c10(local_214,local_210,local_220,local_21c,(float)local_230[0x1c],*param_1,

/* Entry: 0x004d2430; symbol: FUN_004d2430; body bytes: 263 */

void __fastcall FUN_004d2430(int param_1)

{
  ...
  *unaff_FS_OFFSET = (int)&local_10;
  ...
  while( true ) {
    ...
    FUN_00423520((void *)(*piVar4 + 0x6ac),iVar6);
    piVar4 = (int *)FUN_0040f160(p_Var3);
    *(undefined4 *)(*piVar4 + 0x6cc) = 0;
    puVar5 = (undefined4 *)FUN_0040f160(p_Var3);
    (**(code **)(*(int *)*puVar5 + 0x44))(1,0);

/* Entry: 0x00548fb1; symbol: FUN_00548fb1; body bytes: 397 */

uint __thiscall FUN_00548fb1(void *this,byte param_1)
...
LAB_00549092:
  ...
  *(undefined1 *)((int)this + 0x38) = 0;
  if (uVar5 == 8) {
    FUN_005493a1(this,uVar7,local_c,param_1);
  }
  else {
    FUN_0054921f(this,uVar7,param_1);
  }

/* Entry: 0x004f0a40; symbol: FUN_004f0a40; body bytes: 1207 */

/* WARNING: Removing unreachable block (ram,0x004f0c3f) */

void __cdecl
FUN_004f0a40(undefined4 *param_1,undefined4 param_2,uint param_3,int param_4,undefined4 param_5,
...

{
  ...
  *unaff_FS_OFFSET = (int)&local_1c;
  ...
  if ((char)param_6 == 'c') {
    ...
    local_dc = FUN_004710c0(local_70,local_f0,local_ec,local_d4);
    local_c8 = local_70;
    ...
    if (local_71 == '\0') {
      ...
      puVar3 = (undefined4 *)move<>(&param_2);
      local_114 = *puVar3;
      FUN_004efaa0(param_1,local_114,local_110,&param_4,'\x02',local_c4);
      local_14 = 0xffffffff;
      FUN_0040e5a0(local_9c);
    }
    else {
      puVar3 = (undefined4 *)move<>(&param_2);
      FUN_004f6610(local_c4,param_1,*puVar3);
      local_14 = 0xffffffff;
      FUN_0040e5a0(local_9c);
    }
  }

/* Entry: 0x004c9490; symbol: FUN_004c9490; body bytes: 238 */

void __thiscall FUN_004c9490(void *this,undefined4 param_1,undefined4 param_2)
  ...
  *unaff_FS_OFFSET = (int)&local_10;
  ...
  while( true ) {
    ...
    if (*(int *)(*piVar4 + 0x20) != 1) {
      ...
      (**(code **)(*(int *)*puVar5 + 0x44))(param_1,param_2);
    }

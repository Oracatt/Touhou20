/* Entry: 0x00413d80; symbol: FUN_00413d80; body bytes: 145 */

undefined4 * __thiscall FUN_00413d80(void *this,undefined4 *param_1)

{
  ...
  *(undefined4 *)((int)this + 0x28) = param_1[10];
  std::shared_ptr<struct__EXCEPTION_RECORD_const_>::shared_ptr<struct__EXCEPTION_RECORD_const_>
            ((shared_ptr<struct__EXCEPTION_RECORD_const_> *)((int)this + 0x30),
             (shared_ptr<struct__EXCEPTION_RECORD_const_> *)(param_1 + 0xc));

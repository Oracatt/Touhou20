/* Entry: 0x004cbfa0; symbol: FUN_004cbfa0; body bytes: 1767 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void __thiscall
FUN_004cbfa0(void *this,float *param_1,void *param_2,float param_3,undefined4 param_4,int param_5,
            int *param_6)

{
  ...
  if ((param_5 == 0) || (*(int *)((int)this + 0x6cc) == 0)) {
    ...
    pfVar2 = (float *)FUN_00429440(local_26c,local_2a8,param_1);
    local_214 = *pfVar2;
    local_210 = pfVar2[1];
    local_20c = 0;
    ...
    local_23c = 0;
    pfVar2 = (float *)FUN_00452ff0(param_2,local_2b4,DAT_0056c8d0);
    local_220 = *pfVar2;
    local_21c = pfVar2[1];
    local_218 = pfVar2[2];
    FUN_004296e0(&local_214,local_244);
    FUN_004296e0(local_244,local_244);
    FUN_00439330(local_238,local_238,*(float *)((int)local_254 + 0x70),DAT_0056cd90 / DAT_0056c8d0);
    local_230 = 0;
    local_270 = (void *)((int)local_254 + 0x58);
    pfVar2 = (float *)FUN_00429570(local_270,local_2c0,local_238);
    local_22c = *pfVar2;
    local_228 = pfVar2[1];
    local_224 = 0;
    ...
    for (; DAT_0056cd90 / DAT_0056c8d0 + local_25c <= *(float *)((int)local_254 + 0x74);
      ...
      if (*param_6 == 0) {
        ...
        iVar3 = FUN_00485660(local_274,0);
        if (iVar3 != 0) {
          local_278 = (void *)FUN_00412730(*(int *)((int)local_254 + 0x6f0));
          local_27c = (void *)FUN_00485660(local_278,0);
          iVar3 = FUN_004d6b80(local_27c,0);
          iVar3 = FUN_00437cd0(iVar3);
          local_290 = *(float *)(iVar3 + 0x48) * _DAT_00571788;
          local_280 = (void *)FUN_00412730(*(int *)((int)local_254 + 0x6f0));
          local_284 = (void *)FUN_00485660(local_280,0);
          iVar3 = FUN_004d6b80(local_284,0);
          iVar3 = FUN_00437cd0(iVar3);
          local_294 = *(float *)(iVar3 + 0x4c) * _DAT_00571788;
          local_288 = (void *)FUN_00412730(*(int *)((int)local_254 + 0x6f0));
          iVar3 = FUN_00485660(local_288,0);
          iVar3 = FUN_0047a2c0(iVar3);
          local_298 = *(float *)(iVar3 + 4);
          local_28c = (void *)FUN_00412730(*(int *)((int)local_254 + 0x6f0));
          iVar3 = FUN_00485660(local_28c,0);
          pfVar2 = (float *)FUN_0047a2c0(iVar3);
          local_29c = *pfVar2;
          cVar1 = FUN_00457610(local_29c,local_298,local_294,local_290,0.0,local_22c,local_228,
      ...
      if (((((float)((uint)local_220 ^ _DAT_0056d7d0) <= local_214) && (local_214 <= local_220)) &&
        ...
        local_258 = 0xf;
        if (*(float *)((int)local_254 + 0x7c) < DAT_0056f7a8) {
          if ((DAT_0056c8e0 <= *(float *)((int)local_254 + 0x7c)) &&
             (*(float *)((int)local_254 + 0x7c) <= DAT_0056f7a8 &&
              DAT_0056f7a8 != *(float *)((int)local_254 + 0x7c))) {
            local_258 = (int)((((*(float *)((int)local_254 + 0x7c) - DAT_0056c8e0) / DAT_0056d7bc) *
        ...
        if (*(float *)((int)local_254 + 0x78) < DAT_0056fe7c) {
          if ((DAT_0056cd90 <= *(float *)((int)local_254 + 0x78)) &&
            ...
            local_258 = (int)((float)local_258 +
                              ((*(float *)((int)local_254 + 0x78) - DAT_0056cd90) / DAT_0056fa30) *

/* Entry: 0x0054a6f9; symbol: FID_conflict:convert_hexadecimal_string_to_floating_type<double>; body bytes: 33 */
...

{
  ...
  FUN_0054e8ef(param_1,(floating_point_value *)&local_c);
  return;
}

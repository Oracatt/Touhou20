/* Entry: 0x004ef7e0; symbol: FUN_004ef7e0; body bytes: 350 */

void __cdecl
FUN_004ef7e0(undefined4 *param_1,undefined4 param_2,int param_3,int *param_4,char param_5,
            void *param_6)

{
  ...
  puVar1 = FUN_004f5fe0(param_6,&local_34,*puVar1);

/* Entry: 0x00566320; symbol: FUN_00566320; body bytes: 339 */

float10 __cdecl FUN_00566320(double param_1)

{
  ...
  if ((param_1._4_4_ & 0x7ff00000) != 0x7ff00000) {
    ...
    if (((double)fVar3 != param_1) && ((uVar1 & 0x20) == 0)) {
      fVar3 = (float10)FUN_00553a00(0x10,0xc,param_1,(double)fVar3,uVar1);
      return fVar3;
    }
    FUN_0055dbe0();
  ...
  if (((iVar2 != 1) && (iVar2 != 2)) && (iVar2 != 3)) {
    fVar3 = (float10)FUN_00553a00(8,0xc,param_1,param_1 + DAT_0056c468,uVar1);
    return fVar3;
  }
  FUN_0055dbe0();
